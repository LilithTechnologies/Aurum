...
public class AurumElementRow {
    ...
    public AurumElementRow(int spacing) {
        this.spacing = spacing;
    }

    public AurumElementRow() {
        this(1);
    }
     ...
     */
    public AurumElementRow add(Element element, int width) {
    ...
    /**
     * A clickable button element that uses a {@link re.lilith.aurum.gui.GuiUtil.Icon} as its label.
     */
