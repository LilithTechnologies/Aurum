package re.lilith.aurum.targets.render;
...
public class RenderTarget {
    ...
    private void setupTexture(int texture, int width, int height, boolean allowsLinear) {
        ...
        AurumRenderSystem.texParameteri(texture, GL11C.GL_TEXTURE_2D, GL11C.GL_TEXTURE_MIN_FILTER, allowsLinear ? GL11C.GL_LINEAR : GL11C.GL_NEAREST);
        AurumRenderSystem.texParameteri(texture, GL11C.GL_TEXTURE_2D, GL11C.GL_TEXTURE_MAG_FILTER, allowsLinear ? GL11C.GL_LINEAR : GL11C.GL_NEAREST);
    ...
    private void resizeTexture(int texture, int width, int height) {
        AurumRenderSystem.texImage2D(texture, GL11C.GL_TEXTURE_2D, 0, internalFormat.getGlFormat(), width, height, 0, format.getGlFormat(), type.getGlFormat(), NULL_BUFFER);
    }
    ...
    public static class Builder {
        ...
        private final PixelType type = PixelType.UNSIGNED_BYTE;
