...
public class HardcodedCustomUniforms {
    ...
    public static void addHardcodedCustomUniforms(UniformHolder holder, FrameUpdateNotifier updateNotifier) {
        addHardcodedCustomUniforms(holder, updateNotifier, _ -> false);
    }

    public static void addHardcodedCustomUniforms(UniformHolder rawHolder, FrameUpdateNotifier updateNotifier, Predicate<String> declaredByPack) {
        UniformHolder holder = new SkippingUniformHolder(rawHolder, declaredByPack);
    ...
    private static float getEyeSkyBrightness() {
        ...
        BlockPos eyeBlockPos = new BlockPos(new Vec3d(feet.x, getEyeY(), feet.z));
    ...
    private static double getEyeY() {
        return client.getCameraEntity().getPos().y + client.getCameraEntity().getEyeHeight();
    }
    ...
    private static float getRawPrecipitation() {
        if (storedBiome == null || client.world == null || storedBiome.downfall <= 0.0F) {
            return 0;
        }

        if (client.world.getRainGradient(CapturedRenderingState.INSTANCE.getTickDelta()) <= 0.0F) {
            return 0;
        }

        return storedBiome.temperature > 0.15F ? 1 : 2;
    }
    ...
    /**
     * Drops registrations for names the shader pack already declares itself, deferring to the pack's own
     * (more accurate/up to date) expression instead of this class's hardcoded approximation of it.
     */
    private record SkippingUniformHolder(UniformHolder delegate, Predicate<String> skip) implements UniformHolder {
        @Override
        public UniformHolder uniform1f(UniformUpdateFrequency updateFrequency, String name, re.lilith.aurum.gl.uniform.FloatSupplier value) {
            return skip.test(name) ? this : delegate.uniform1f(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniform1f(UniformUpdateFrequency updateFrequency, String name, IntSupplier value) {
            return skip.test(name) ? this : delegate.uniform1f(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniform1f(UniformUpdateFrequency updateFrequency, String name, DoubleSupplier value) {
            return skip.test(name) ? this : delegate.uniform1f(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniform1i(UniformUpdateFrequency updateFrequency, String name, IntSupplier value) {
            return skip.test(name) ? this : delegate.uniform1i(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniform1b(UniformUpdateFrequency updateFrequency, String name, java.util.function.BooleanSupplier value) {
            return skip.test(name) ? this : delegate.uniform1b(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniform2f(UniformUpdateFrequency updateFrequency, String name, java.util.function.Supplier<org.joml.Vector2f> value) {
            return skip.test(name) ? this : delegate.uniform2f(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniform2i(UniformUpdateFrequency updateFrequency, String name, java.util.function.Supplier<org.joml.Vector2i> value) {
            return skip.test(name) ? this : delegate.uniform2i(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniform3f(UniformUpdateFrequency updateFrequency, String name, java.util.function.Supplier<org.joml.Vector3f> value) {
            return skip.test(name) ? this : delegate.uniform3f(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniform3i(UniformUpdateFrequency updateFrequency, String name, java.util.function.Supplier<org.joml.Vector3ic> value) {
            return skip.test(name) ? this : delegate.uniform3i(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniformVanilla3f(UniformUpdateFrequency updateFrequency, String name, java.util.function.Supplier<org.lwjgl.util.vector.Vector3f> value) {
            return skip.test(name) ? this : delegate.uniformVanilla3f(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniformTruncated3f(UniformUpdateFrequency updateFrequency, String name, java.util.function.Supplier<org.joml.Vector4f> value) {
            return skip.test(name) ? this : delegate.uniformTruncated3f(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniform3d(UniformUpdateFrequency updateFrequency, String name, java.util.function.Supplier<org.joml.Vector3d> value) {
            return skip.test(name) ? this : delegate.uniform3d(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniform4f(UniformUpdateFrequency updateFrequency, String name, java.util.function.Supplier<org.joml.Vector4f> value) {
            return skip.test(name) ? this : delegate.uniform4f(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniformMatrix(UniformUpdateFrequency updateFrequency, String name, java.util.function.Supplier<org.lwjgl.util.vector.Matrix4f> value) {
            return skip.test(name) ? this : delegate.uniformMatrix(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniformJomlMatrix(UniformUpdateFrequency updateFrequency, String name, java.util.function.Supplier<org.joml.Matrix4f> value) {
            return skip.test(name) ? this : delegate.uniformJomlMatrix(updateFrequency, name, value);
        }

        @Override
        public UniformHolder uniformMatrixFromArray(UniformUpdateFrequency updateFrequency, String name, java.util.function.Supplier<float[]> value) {
            return skip.test(name) ? this : delegate.uniformMatrixFromArray(updateFrequency, name, value);
        }

        @Override
        public UniformHolder externallyManagedUniform(String name, re.lilith.aurum.gl.uniform.UniformType type) {
            return skip.test(name) ? this : delegate.externallyManagedUniform(name, type);
        }
    }
}
