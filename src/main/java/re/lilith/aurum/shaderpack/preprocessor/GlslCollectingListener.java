...
public class GlslCollectingListener extends DefaultPreprocessorListener {
    public static final String VERSION_MARKER = "#warning AURUM_JCPP_GLSL_VERSION";
    public static final String EXTENSION_MARKER = "#warning AURUM_JCPP_GLSL_EXTENSION";
