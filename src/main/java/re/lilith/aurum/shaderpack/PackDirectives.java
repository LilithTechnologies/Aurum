...
import re.lilith.aurum.gl.texture.TextureScaleOverride;
...
public class PackDirectives {
    ...
    public PackDirectives(Set<Integer> supportedRenderTargets, ShaderProperties properties) {
        ...
        particlesBeforeDeferred = properties.getParticleRenderingSettings()
    ...
    public ImmutableMap<Integer, Boolean> getExplicitFlips(String pass) {
        ...
        explicitFlipsStr.forEach((buffer, shouldFlip) -> {
            ...
            if (index != -1) {
                ...
                Aurum.LOGGER.warn("Unknown buffer with ID " + buffer + " specified in flip directive for pass "
                        + pass);
            }
        });
